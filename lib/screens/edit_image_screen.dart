...
import 'package:image_editor_tutorial/services/edit_user_service.dart';
...
class _EditImageScreenState extends EditImageViewModel {
          ...
          children: [
            ...
            Screenshot(
              ...
              child: SizedBox(
                 height:
                 (){
                   print(MediaQuery.of(context).size.height*0.47);
                   return 411.11;
                 }(),
                //height: 100,
                child: Stack(
  ...
  AppBar get _appBar => AppBar(
      ...
      centerTitle: true,
      title:  Text("Designer",style: TextStyle(color: Colors.black),)
  );
}
