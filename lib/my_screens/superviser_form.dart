...
class SuperviserFormScreen extends StatefulWidget {
  final File file1;

  const SuperviserFormScreen({Key? key,required this.file1}) : super(key: key);

  @override
  _SuperviserFormScreenState createState() => _SuperviserFormScreenState();
}

class _SuperviserFormScreenState extends State<SuperviserFormScreen> {
        ...
        onPressed: () {
          ...
          // }
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context)=>
                SuperviserFrameScreen(recognition_name: nameController.text, file: widget.file1,)));
