...
class AmbassadorFormScreen extends StatefulWidget {

  final File file1;

  const AmbassadorFormScreen({Key? key,required this.file1}) : super(key: key);

  @override
  _AmbassadorFormScreenState createState() => _AmbassadorFormScreenState();
}

class _AmbassadorFormScreenState extends State<AmbassadorFormScreen> {
        ...
        onPressed: () {
          ...
          // }
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context)=>
                AmbassadorFrameScreen(recognition_name: nameController.text, file: widget.file1,)));
